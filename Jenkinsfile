pipeline {
    ...
    stages {
        ...
        // KEY FIX: withCredentials injects kubeconfig so kubectl knows
        // where Minikube is. Without this kubectl hits a login page
        // instead of the cluster — root cause of the original error.
        // set -x prints every command so you can see output in Jenkins Console.
